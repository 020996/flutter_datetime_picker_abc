...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? DatePickerThemeAbc(),
  ...
  final DatePickerThemeAbc theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    DatePickerThemeAbc theme = widget.route.theme;
  ...
  Widget _renderPickerView(DatePickerThemeAbc theme) {
  ...
  Widget _renderItemView(DatePickerThemeAbc theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(DatePickerThemeAbc theme) {
